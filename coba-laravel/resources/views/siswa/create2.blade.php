...
<form action="/pembayaran/input2" method="POST">
       @csrf
	   <div class="war">
	   <select name="NISN">
		<option value="">Pilih NISN</option>
		@foreach ($sppOptions as $NISN)
			<option value="{{ $NISN }}">{{ $NISN }}</option>
		@endforeach
	</select><br>
	
    <input type="number" name="ID_STAF_ATAU_GURU" placeholder="ID_STAF_ATAU_GURU"> <br>
    <input type="date" name="TANGGAL_PEMBAYARAN" placeholder="TANGGAL_PEMBAYARAN"> <br>
