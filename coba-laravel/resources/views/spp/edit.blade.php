...
<form action="/spp/{{$spp->id}}" method="POST">
    @method('put')
       @csrf
	   <div class="war">
    <input type="number" name="NISN" placeholder="NISN" value="{{$spp->NISN}}"> <br>
    <input type="text" name="NAMA_SISWA" placeholder="NAMA_SISWA" value="{{$spp->NAMA_SISWA}}"> <br>
    <input type="text" name="KELAS_JURUSAN" placeholder="KELAS_JURUSAN" value="{{$spp->KELAS_JURUSAN}}"> <br>
	<div class="mn"></div>
